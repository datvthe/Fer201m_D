...
public class AddController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        int frate=Integer.parseInt(request.getParameter("frate"));
        ...
        Food food= new Food();
        f.addFood( fname, fprice, frate, flocation, ftitle, fcomment,fimage);
        
        request.setAttribute("messages", "Add food successful!!");
